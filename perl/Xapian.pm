...
*equal = *Xapianc::PositionIterator_equal;
*nequal = *Xapianc::PositionIterator_nequal;
*get_termpos = *Xapianc::PositionIterator_get_termpos;
*inc = *Xapianc::PositionIterator_inc;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*inc = *Xapianc::PostingIterator_inc;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
*get_unique_terms_end = *Xapianc::Query_get_unique_terms_end;
...
*inc = *Xapianc::MSetIterator_inc;
*dec = *Xapianc::MSetIterator_dec;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*inc = *Xapianc::ESetIterator_inc;
*dec = *Xapianc::ESetIterator_dec;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*equal = *Xapianc::LatLongCoordsIterator_equal;
*nequal = *Xapianc::LatLongCoordsIterator_nequal;
*get_coord = *Xapianc::LatLongCoordsIterator_get_coord;
*inc = *Xapianc::LatLongCoordsIterator_inc;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*get_average_length = *Xapianc::Database_get_average_length;
...
*add_database = *Xapianc::WritableDatabase_add_database;
...
sub ENQ_ASCENDING () { $Xapianc::ENQ_ASCENDING }
sub ENQ_DESCENDING () { $Xapianc::ENQ_DESCENDING }
sub ENQ_DONT_CARE () { $Xapianc::ENQ_DONT_CARE }
sub FLAG_ACCUMULATE () { $Xapianc::FLAG_ACCUMULATE }
sub FLAG_BOOLEAN () { $Xapianc::FLAG_BOOLEAN }
sub FLAG_NO_POSITIONS () { $Xapianc::FLAG_NO_POSITIONS }
