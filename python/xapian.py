...
Query.get_unique_terms_end = new_instancemethod(_xapian.Query_get_unique_terms_end, None, Query)
...
Stem.is_none = new_instancemethod(_xapian.Stem_is_none, None, Stem)
...
Database.size = new_instancemethod(_xapian.Database_size, None, Database)
...
Database.get_average_length = new_instancemethod(_xapian.Database_get_average_length, None, Database)
...
WritableDatabase.add_database = new_instancemethod(_xapian.WritableDatabase_add_database, None, WritableDatabase)
